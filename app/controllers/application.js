      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.mu12.caption'),
          title: i18n.t('forms.application.sitemap.mu12.title'),
          children: [{
            link: 'i-i-s-mu12-f32-l',
            caption: i18n.t('forms.application.sitemap.mu12.i-i-s-mu12-f32-l.caption'),
            title: i18n.t('forms.application.sitemap.mu12.i-i-s-mu12-f32-l.title'),
            children: null
          }]
        }
      ]
